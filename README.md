...
I'm using the DQN algorithm to solve this problem. This choice is motivated by the fact that the action space is discreet and DQN has shown quite an impressive performance in past.

The network comprises of fully connected layers, with 64 units in 2 hidden layers each.
...
In future I would like to test the implementation using raw pixels. Further, using Duelling DQN or Double DQN would be useful. 
